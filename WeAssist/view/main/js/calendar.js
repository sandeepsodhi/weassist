...
(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<span class="prev" title="AB" data-calendar-arrow-date>{prev}</span>',
            '<span class="next" title="CD" data-calendar-arrow-date>{next}</span>',
            '</div>',
            '</div>',
            ...
            '<div class="calendar-arrow">',
            '<span class="prev" title="EF" data-calendar-arrow-month>{prev}</span>',
            '<span class="next" title="IJ" data-calendar-arrow-month>{next}</span>',
            '</div>',
            '</div>',
