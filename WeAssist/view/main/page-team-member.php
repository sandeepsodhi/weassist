...
<!-- Mirrored from handyman.dan-fisher.com/page-team-member.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Jan 2016 06:56:31 GMT -->
<head>

	<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Team Member | Handyman - Job Board HTML Template</title>
			...
			<section class="page-content">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="team-single-head">
								<h2>Erick Terry <small>/ Painter</small></h2>
							</div>
					...
					<div class="row">
						<div class="col-md-6">
							<h3>About Me</h3>
							<p>Our goal is to bring the best customer service along with the best granite price with quick turnaround time to you. Marble Town is the perfect choice for residential homeowners, builders and developers and commercial contractors to rely on for their Granite needs.</p>

							<blockquote>
								<p>Quality Jobs You Can Afford</p>
							</blockquote>

							<p> We manufacture our granite with personal care making sure that our granite meets the quality and standards for our customers. Working with homeowners, builders and developers, we pride ourselves in 100% customer satisfaction.</p>

							<p>We use only the highest quality Granite to ensure customer satisfaction we carry a vast selection of granite in stock. We are capable of matching any of your cabinet colours with our stock. In addition to that, we are ready to help you choose the color of your choice, making your decision process quick and easy.</p>
					...
					<ul class="team-list row">
						<li class="team-item col-md-3">
							<div class="team-item-inner">
								<figure class="team-thumb">
									<img src="images/samples/team-member-1.jpg" alt="">
								</figure>
								<div class="team-body">
									<h5 class="team-name">Michael Smith</h5>
									<span class="team-body-info">Painter</span>
						...
						<li class="team-item col-md-3">
							<div class="team-item-inner">
								<figure class="team-thumb">
									<img src="images/samples/team-member-2.jpg" alt="">
								</figure>
								<div class="team-body">
									<h5 class="team-name">Bradley Cooper</h5>
									<span class="team-body-info">Carpenter</span>
									<ul class="team-social list-unstyled">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
						...
						<li class="team-item col-md-3">
							<div class="team-item-inner">
								<figure class="team-thumb">
									<img src="images/samples/team-member-3.jpg" alt="">
								</figure>
								<div class="team-body">
									<h5 class="team-name">Hanna Pinkman</h5>
									<span class="team-body-info">Plumber</span>
									<ul class="team-social list-unstyled">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
						...
						<li class="team-item col-md-3">
							<div class="team-item-inner">
								<figure class="team-thumb">
									<img src="images/samples/team-member-4.jpg" alt="">
								</figure>
								<div class="team-body">
									<h5 class="team-name">Erick Fox</h5>
									<span class="team-body-info">Architect</span>
									<ul class="team-social list-unstyled">
										<li><a href="#"><i class="fa fa-facebook"></i></a></li>
										<li><a href="#"><i class="fa fa-twitter"></i></a></li>
										<li><a href="#"><i class="fa fa-google-plus"></i></a></li>
