...
$query4="SELECT s.subcat_name,u.f_name,u.l_name,u.profile_pic,u.city,u.u_name from sub_category s,users u where s.subcat_id='".$row3['subcat_id']."' AND u.u_name='".$row3['u_name']."'";
