...
<!-- Mirrored from handyman.dan-fisher.com/page-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Jan 2016 06:56:34 GMT -->
<head>

	<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Page Right Sidebar | Handyman - Job Board HTML Template</title>
					...
					<div class="row">
						<div class="content col-md-8">
							...
							<div class="title-accent">
								<h3>Right Sidebar Page</h3>
							</div>

							<figure class="alignleft">
								<img src="images/samples/img2.jpg" alt="">
							</figure>

							<p>Building construction is the process of adding structure to real property or construction of buildings. The vast majority of building construction jobs are small renovations, such as addition of a room, or renovation of a bathroom. Often, the owner of the property acts as laborer, paymaster, and design team for the entire project.</p> 

							<div class="list">
								<ul>
									<li>Frame out interior walls with wooden 2x4s</li>
									<li>Add internal plumbing, HVAC, electrical, and natural gas utilities</li>
									<li>Install major appliances</li>
