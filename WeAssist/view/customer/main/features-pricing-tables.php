...
<!-- Mirrored from handyman.dan-fisher.com/features-pricing-tables.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Jan 2016 06:56:34 GMT -->
<head>

	<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Pricing Tables | Handyman - Job Board HTML Template</title>
		...
		<div class="main" role="main">
			...
			<section class="page-content">
				<div class="container">
					...
					<h2>Style 4 (4 columns)</h2>
					<div class="row">
						<div class="pricing-table pricing-table__style4">
							<div class="col-md-3">
								<div class="plan">
									<header class="pricing-head">
										<h3>Free</h3>
