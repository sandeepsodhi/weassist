...
<!-- Mirrored from handyman.dan-fisher.com/features-shortcodes.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Jan 2016 06:56:34 GMT -->
<head>

	<!-- Basic Page Needs
	================================================== -->
	<meta charset="utf-8">
	<title>Shortcodes | Handyman - Job Board HTML Template</title>
			...
			<section class="page-content">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-2">
							<a href="#" class="btn btn-warning">Normal</a>
						</div>
						<div class="col-md-2">
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="form-group">
								<textarea name="textarea" cols="30" rows="10" class="form-control" placeholder="Textarea"></textarea>
							</div>
						</div>
						<div class="col-md-4">
							<h4>Dropdown</h4>
						...
						<div class="col-md-4">
							<h4>Radio Buttons / Check Boxes</h4>
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-3">
									<div class="radio radio__custom radio__style2">
										<label>
											<input type="radio" name="optionsRadios2" id="optRadio21" value="option1" checked>
											<span>Opt 1</span>
										</label>
									</div>
									<div class="radio radio__custom radio__style2">
										<label>
											<input type="radio" name="optionsRadios2" id="optRadio22" value="option1">
											<span>Opt 2</span>
										</label>
									</div>
								</div>
								<div class="col-md-3">
									<div class="radio radio__custom radio__style3">
										<label>
											<input type="radio" name="optionsRadios3" id="optRadio31" value="option1" checked>
											<span>Opt 1</span>
										</label>
									</div>
									<div class="radio radio__custom radio__style3">
										<label>
											<input type="radio" name="optionsRadios3" id="optRadio32" value="option1">
											<span>Opt 2</span>
										</label>
									</div>
								</div>
								<div class="col-md-3">
									<div class="radio radio__custom radio__style4">
										<label>
											<input type="radio" name="optionsRadios4" id="optRadio41" value="option1" checked>
											<span>Opt 1</span>
										</label>
									</div>
									<div class="radio radio__custom radio__style4">
										<label>
											<input type="radio" name="optionsRadios4" id="optRadio42" value="option1">
											<span>Opt 2</span>
										</label>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="checkbox checkbox__custom checkbox__style2">
										<label>
											<input type="checkbox" value="" checked>
											<span>Opt 1</span>
										</label>
								...
								<div class="col-md-3">
									<div class="checkbox checkbox__custom checkbox__style3">
										<label>
											<input type="checkbox" value="" checked>
											<span>Opt 1</span>
										</label>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="tabs">
								...
								<ul class="nav nav-tabs">
									<li class="active"><a href="#tab1-1" data-toggle="tab">Tab #1</a></li>
									<li><a href="#tab1-2" data-toggle="tab">Tab #2</a></li>
									<li><a href="#tab1-3" data-toggle="tab">Tab #3</a></li>
								</ul>
								<!-- Tab panes -->
								<div class="tab-content">
									<div class="tab-pane fade in active" id="tab1-1">
										<p>This is a element called Tabs (Tabbed Content).</p>
										<p>You can place here short or long description. You can also easily past here images, tables, or even grid system. There is no limitation!</p>
										<p><strong>Nested tabs are not supported.</strong></p>
									</div>
						...
						<div class="col-md-6">
							...
							<div class="tabs">
								<!-- Nav tabs -->
								<ul class="nav nav-tabs">
									<li class="active"><a href="#tab2-1" data-toggle="tab"><i class="fa fa-globe"></i> Tab #1</a></li>
									<li><a href="#tab2-2" data-toggle="tab"><i class="fa fa-pencil"></i> Tab #2</a></li>
									<li><a href="#tab2-3" data-toggle="tab"><i class="fa fa-cloud-upload"></i> Tab #3</a></li>
								</ul>
								<!-- Tab panes -->
								<div class="tab-content">
					...
					<div class="call-to-action">
						<div class="cta-txt">
							...
							<p>We'll ask you a few important questions to ensure we're able to match you to the right pro for your job</p>
						</div>
						<div class="cta-btn">
					...
					<div class="call-to-action centered">
						<div class="cta-txt">
							<h2>Get Matched by Our Technology</h2>
							<p>You'll receive information for up to four pre-screened, local home improvement pros</p>
						</div>
						<div class="cta-btn">
							<a href="#" class="btn btn-primary">Read More</a>
						</div>
						...
						<div class="col-md-4">
							<div class="icon-box">
								...
								<div class="icon-box-body">
									<h3>User Icon</h3>
									This is the place for short description. Please don't use this for complicated content such as tables, sliders or tabs.
								</div>
							</div>
						</div>
						<div class="col-md-4">
					...
					<div class="table-responsive">
						<table class="table table-striped table-bordered">
							...
							<tbody>
								<tr>
									<td>Short description goes here.</td>
									<td>Short description goes here.</td>
									<td>Short description goes here.</td>
									<td>Short description goes here.</td>
								</tr>
								...
								<tr>
									<td>1 Job Listing</td>
									<td>2 Job Listings</td>
									<td>5 Job Listings</td>
									<td>Unlimited Job Listing</td>
								</tr>
								<tr>
									<td>And another description</td>
									<td>And another description</td>
									<td>And another description</td>
									<td>And another description</td>
								</tr>
								<tr>
									<td><a href="#" class="btn btn-default btn-sm">Read More</a></td>
									<td><a href="#" class="btn btn-default btn-sm">Read More</a></td>
									<td><a href="#" class="btn btn-default btn-sm">Read More</a></td>
									<td><a href="#" class="btn btn-default btn-sm">Read More</a></td>
								</tr>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="testimonial">
								<blockquote>
									<p>This is testimonial block. You simply remove thumbnail. Also as you can see you can display star rating at the bottom right.</p>
								</blockquote>
								<div class="bq-author">
					...
					<div class="row">
						<div class="col-md-4">
							<p>Modals are streamlined, but flexible, dialog prompts with the minimum required functionality and smart defaults. Modals have two optional sizes, available via modifier classes to be placed on a <code>.modal-dialog</code>.</p>

							<!-- Button trigger modal -->
							<button class="btn btn-primary" data-toggle="modal" data-target="#bsModal1">
								Normal Modal
							</button>
						...
						<div class="col-md-4">
							...
							<!-- Button trigger modal -->
							<button class="btn btn-primary" data-toggle="modal" data-target="#bsModal2">
								Large Modal
							</button>
