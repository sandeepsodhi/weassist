...
<body>
	...
	<div class="site-wrapper">
		...
		<!-- Header -->		<header class="header header-menu-fullw">
		                        ...
		                        <div class="input-group col-xs-10 col-sm-10 dialog-s">
		                            <div class="input-group-addon">
		                                <i class="fa fa-at"></i>
                                            ...
                                            <input type="email" class="form-control" id="u_name" name="u_name" placeholder="Email" required>
		                        </div>
		                    </div>
		                    <div class="form-group">
	 	                       <div class="input-group col-xs-10 col-sm-10 dialog-s">
		                        ...
		                        <div class="input-group col-xs-10 col-sm-10 dialog-s">
		                            <div class="input-group-addon">
		                                <i class="fa fa-phone"></i>
                                            ...
                                            <input type="tel" class="form-control" id="contact" name="contact" placeholder="Contact" onkeyup="phonenumber(this)" required>
		                        </div>
		                    </div>
		                    <!--
		                    <div class="form-group">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="input-group col-xs-10 col-sm-10 dialog-s">
		                        	<div class="bs-docs-masthead" style="margin-left:410px;margin-top:-30px">
							            <input id="u_type" value="agent" type="checkbox">
									</div>
		                        </div>
		                    </div>
		                    <div class="form-group">
