...
<!-- Mirrored from tattek.sk/minimal/form-elements.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Jan 2016 04:39:26 GMT -->
<head>
    <title>Minimal 1.3 - Form Elements</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="UTF-8" />

    <link rel="icon" type="image/ico" href="assetse/images/favicon.ico" />
    <!-- Bootstrap -->
    <link href="assetse/css/vendor/bootstrap/bootstrap.min.css" rel="stylesheet">
    <link href="maxcdn.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css" rel="stylesheet">
    <link rel="stylesheet" href="assetse/css/vendor/animate/animate.css">
    <link type="text/css" rel="stylesheet" media="all" href="assetse/js/vendor/mmenu/css/jquery.mmenu.all.css" />
    <link rel="stylesheet" href="assetse/js/vendor/videobackground/css/jquery.videobackground.css">
    <link rel="stylesheet" href="assetse/css/vendor/bootstrap-checkbox.css">
    <link rel="stylesheet" href="assetse/css/vendor/bootstrap/bootstrap-dropdown-multilevel.css">

    <link rel="stylesheet" href="assetse/js/vendor/summernote/css/summernote.css">
    <link rel="stylesheet" href="assetse/js/vendor/summernote/css/summernote-bs3.css">
    <link rel="stylesheet" href="assetse/js/vendor/chosen/css/chosen.min.css">
    <link rel="stylesheet" href="assetse/js/vendor/chosen/css/chosen-bootstrap.css">
    <link rel="stylesheet" href="assetse/js/vendor/datepicker/css/bootstrap-datetimepicker.css">
    <link rel="stylesheet" href="assetse/js/vendor/colorpicker/css/bootstrap-colorpicker.css">
    <link rel="stylesheet" href="assetse/js/vendor/colorpalette/bootstrap-colorpalette.css">

    <link href="assetse/css/minimal.css" rel="stylesheet">
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-thumb-tack" style="line-height: 48px;padding-left: 1px;"></i> Form Elements <span>// Place subtitle here...</span></h2>
                    ...
                    <form class="form-horizontal" role="form">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          ...
                          <span class="help-block">You can use classes <code>.input-sm</code> and <code>.input-lg</code> for selectbox sizing.</span>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label for="datepicker" class="col-sm-4 control-label">Datetimepicker field</label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Colorpalette</label>
                        <div class="col-sm-8">
                ...
                <section class="tile">
                  ...
                  <div class="tile-body">
                    ...
                    <div class="input-group input-group-lg margin-bottom-20">
                      <span class="input-group-addon addon-blue">@</span>
                      <input type="text" class="form-control" placeholder="Username">
                    </div>

                    <div class="input-group margin-bottom-20">
                      <span class="input-group-addon addon-redbrown">@</span>
                      <input type="text" class="form-control" placeholder="Username">
                    </div>

                    <div class="input-group input-group-sm margin-bottom-20">
                      <span class="input-group-addon addon-slategray">@</span>
                      <input type="text" class="form-control" placeholder="Username">
                    </div>

                    <h4><strong>Checkboxes</strong> and radio addons</h4>
                    ...
                    <h4><strong>Button addons</strong></h4>
...
<!-- Mirrored from tattek.sk/minimal/form-elements.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 22 Jan 2016 04:39:35 GMT -->
</html>
