...
$rs=mysqli_query($conn,"select a.image,b.f_name,a.city,a.contact,b.u_type from profession a join users b on a.u_id=b.u_id where a.cat_name='".$_SESSION['category']."' AND a.subcat_name='".$_SESSION['sub_category']."' AND a.city='".$_SESSION['city']."' ");
