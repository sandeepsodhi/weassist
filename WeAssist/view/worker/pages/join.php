...
var d = "<?php echo "select channel from chat_user where pr_id in(select pr_id from profession where cat_id='$cat_id' and subcat_id='$subcat_id' and u_id in(select u_id from users where city='$subcat_city'))"   ?>";	
