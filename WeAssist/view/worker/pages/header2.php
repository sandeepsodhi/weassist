        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="image/<?php  echo $_SESSION['profile_pic']; ?>" class="user-image" alt="User Image" id="change_image" style="width:40px;height:40px;">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="image/<?php  echo $_SESSION['profile_pic']; ?>" class="img-circle" alt="User Image" id="change_image1" style="width:50%;height:50%;">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel"style="height:70px;">
        <div class="pull-left image">
          <img src="image/<?php echo $_SESSION['profile_pic']; ?>" class="img-circle" alt="User Image"  style="width:30px;height:40px;"id="change_image2"/>
        </div>
